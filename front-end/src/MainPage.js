  ...
  return (
    <div id="mainDiv">
      <div id="side">
        ...
        <Linker ali = "left" var = "primary" action = "/createcall" name = "Start Call" cn="sidebar"> </Linker>
        <Linker ali = "left" var = "primary" action = "/recent" name = "Recent Calls" cn="sidebar"> </Linker>
        <br></br>
      </div>
      <Textbox ali = "center" mess = "Enter Call Name: " action = "/chatroom" tag = "title" name = "Join Call" cn="callNameField"> </Textbox>
